...
class BaseEvolution(ABC):
    ...
    def _mutate_one(self, parent: RobotMorphology) -> RobotMorphology:
        ...
        return MutateMorphology(
            ...
            torso_a_std               = self.cfg.torso_a_std,
            torso_b_std               = self.cfg.torso_b_std,
            torso_c_std               = self.cfg.torso_c_std,
            torso_euler_std           = self.cfg.torso_euler_std,
            add_remove_body_part_prob = self.cfg.add_remove_body_part_prob,
            body_part_a_std           = self.cfg.body_part_a_std,
            body_part_b_std           = self.cfg.body_part_b_std,
            body_part_c_std           = self.cfg.body_part_c_std,
